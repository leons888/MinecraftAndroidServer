...
final class RuntimeInstaller {
 ...
 private static final String[] REQUIRED={"libc.so.6","libm.so.6","libpthread.so.0","libdl.so.2","librt.so.1","libgcc_s.so.1","libstdc++.so.6","libzstd.so.1","ld-linux-x86-64.so.2"};
