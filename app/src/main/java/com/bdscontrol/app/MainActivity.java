...
import android.app.*;import android.os.*;import android.view.*;import android.webkit.*;import android.net.Uri;import android.content.*;import android.widget.Toast;
...
public final class MainActivity extends Activity {
 ...
 void copyToClipboard(String text){((android.content.ClipboardManager)getSystemService(CLIPBOARD_SERVICE)).setPrimaryClip(ClipData.newPlainText("BDS logs",text==null?"":text));Toast.makeText(this,"Логи скопированы",Toast.LENGTH_SHORT).show();}
 ...
 @Override public void onBackPressed(){if(webView!=null&&webView.canGoBack())webView.goBack();else super.onBackPressed();}@Override protected void onDestroy(){if(serverManager!=null)serverManager.stopAll();if(webView!=null)webView.destroy();super.onDestroy();}
}
