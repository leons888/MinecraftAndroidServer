...
public final class AndroidBridge {
 ...
 @JavascriptInterface public void install(String version,String url,String sha256){manager.install(version,url,sha256);}@JavascriptInterface public void pickLocalZip(){activity.pickLocalZip();}
 @JavascriptInterface public void copyLogs(String text){activity.copyToClipboard(text);}@JavascriptInterface public void start(){manager.start();}@JavascriptInterface public void stop(){manager.stop();}@JavascriptInterface public void restart(){manager.restart();}@JavascriptInterface public void sendCommand(String command){manager.sendCommand(command);}@JavascriptInterface public String status(){return manager.statusJson();}@JavascriptInterface public String system(){return manager.systemJson();}
