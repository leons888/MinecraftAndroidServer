...
public final class AndroidBridge {
    ...
    @JavascriptInterface public String capabilities(){ return "{\"officialBds\":true,\"nativeArm64Bds\":false,\"embeddedRuntime\":true,\"termux\":false,\"playit\":\"external-agent-required\"}"; }
    ...
    @JavascriptInterface public String system(){ return manager.systemJson(); }
}
