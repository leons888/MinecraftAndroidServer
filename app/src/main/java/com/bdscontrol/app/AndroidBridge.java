...
public final class AndroidBridge {
 ...
 @JavascriptInterface public void playitStart(String args){manager.playitStart(args);}
 @JavascriptInterface public void playitCommand(String line){manager.playitCommand(line);}
 @JavascriptInterface public void playitStop(){manager.playitStop();}
}
