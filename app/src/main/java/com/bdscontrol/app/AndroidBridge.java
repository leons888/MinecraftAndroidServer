...
public final class AndroidBridge {
 ...
 @JavascriptInterface public void listBdsVersions(){manager.listBdsVersions();}
 @JavascriptInterface public void install(String version,String url,String sha256){manager.install(version,url,sha256);}
 @JavascriptInterface public void pickLocalZip(){activity.pickLocalZip();}
 ...
 public void onLocalZip(android.net.Uri uri){manager.installLocal(uri);}
}
